...
layui.sykDict = {
    	...
    	select_province : {
			formatType : "server",
			sqlid:"admin.city.findProvince&pageSize=35",
			labelField : "areaname",
			valueField : "areaid"
		},
		//市
		select_city : {
			formatType : "server",
			sqlid:"admin.city.findCityById",
			labelField : "areaname",
			valueField : "areaid",
            inputs: "parentid:#sel_province",
            action: "admin/city/initCity.json"
		},
		//县
		select_county : {
			formatType : "server",
			sqlid:"admin.city.findCountyById",
			labelField : "areaname",
			valueField : "areaid",
            inputs: "parentid:#sel_city",
            action: "admin/city/initCounty.json"
		},
    ...
    index : {
        ...
        labelField : "name",
        valueField : "code",
        data:[{"code":"index.html","name":"1","css":"layui-badge layui-bg-orange"},
            {"code":"index1.html","name":"2","css":"layui-badge layui-bg-cyan"}]
    }
